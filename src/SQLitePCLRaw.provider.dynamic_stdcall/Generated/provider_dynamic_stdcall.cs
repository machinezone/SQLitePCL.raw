...
// TODO obsolete.  just throw?
	...
	static class MyDelegateTypes
	{
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public unsafe delegate IntPtr sqlite3_malloc64(ulong n);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public unsafe delegate IntPtr sqlite3_serialize(sqlite3 db, byte* schema, out long size, uint flags);

		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public unsafe delegate int sqlite3_deserialize(sqlite3 db, byte* schema, IntPtr data, long szDb, long szBuf, uint flags);
